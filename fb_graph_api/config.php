...
/**
 * Config file for Facebook Graph API Explorer
 *
 * @package			Facebook Graph API Explorer
 * @author			Siegert Naber <https://github.com/Zignature/>
...
if ( ! defined('FB_GRAPH_API_MOD_NAME'))
{
	...
	define('FB_GRAPH_API_MOD_VER', '1.1.4');
}
